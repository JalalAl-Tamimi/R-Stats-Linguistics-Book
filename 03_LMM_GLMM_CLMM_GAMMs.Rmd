...
```{r warning=FALSE, message=FALSE, error=FALSE}
print(tab_model(mdl.glmmSlope2))
```
...
```{r warning=FALSE, message=FALSE, error=FALSE}
print(tab_model(mdl.glmmSlope3))
```
...
```{r warning=FALSE, message=FALSE, error=FALSE}
print(tab_model(mdl.clmm.Int.1))
```
...
```{r warning=FALSE, message=FALSE, error=FALSE}
print(tab_model(mdl.gamm.F2.AR))
```
