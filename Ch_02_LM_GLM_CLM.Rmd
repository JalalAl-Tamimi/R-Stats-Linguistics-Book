...
statistically significant difference between the two groups: `setosa`
and `versicolor`: `t(4534.6) = 67.468, p < 2.2e-16`. The mean of
...
$\beta$ coefficient for `versicolor` is significantly higher than that
of `setosa` by `0.93000`: `t(98) = 10.52, p < <2e-16`.
