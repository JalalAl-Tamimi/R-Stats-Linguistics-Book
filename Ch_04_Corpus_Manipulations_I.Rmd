# (PART) Qualitative data analysis and corpora {-}
# Creating a corpus and basic manipulations {#chap:Corpus-Basic}
...
This dataset comes as well in PDF formats. We can import data in a PDF format and obtain details from file name. 
...
We reuse the original data from text files to create a corpus.
